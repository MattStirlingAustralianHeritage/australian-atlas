...
const VERTICAL_FIELDS = {
  ...
  collection: [
    { key: 'institution_type', label: 'Institution Type', type: 'select', options: [
      ...
      { value: 'cinema', label: 'Cinema' }, { value: 'drive_in', label: 'Drive-In' },
      { value: 'live_music_venue', label: 'Live Music Venue' }, { value: 'comedy_club', label: 'Comedy Club' },
  ...
  corner: [
    { key: 'shop_type', label: 'Shop Type', type: 'select', options: [
      ...
      { value: 'food_drink', label: 'Food & Drink' }, { value: 'bottle_shop', label: 'Bottle Shop' },
  ...
  table: [
    { key: 'food_type', label: 'Food Type', type: 'select', options: [
      ...
      { value: 'farm_gate', label: 'Farm Gate' }, { value: 'pick_your_own', label: 'Pick Your Own Farm' },
      ...
      { value: 'food_trail', label: 'Food Trail' }, { value: 'creamery', label: 'Creamery' },
      { value: 'chocolatier', label: 'Chocolatier' }, { value: 'confectioner', label: 'Confectioner' },
      { value: 'tea_shop', label: 'Tea Shop' }, { value: 'wine_bar', label: 'Wine Bar' },
    ]},
  ...
  return (
    <>
      ...
      {!open && (
        <button
          onClick={openPanel}
          aria-label={{ en: 'Edit listing', ko: '목록 편집', zh: '编辑条目' }[locale] || 'Edit listing'}
          style={{
        ...
        >
          ...
          {{ en: 'Edit listing', ko: '목록 편집', zh: '编辑条目' }[locale] || 'Edit listing'}
        </button>
      )}
