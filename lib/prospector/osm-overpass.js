...
export const OSM_SELECTORS = {
  ...
  field: ['leisure=nature_reserve', 'boundary=national_park', 'boundary=protected_area', 'leisure=garden', 'tourism=zoo', 'tourism=aquarium', 'tourism=attraction', 'tourism=wilderness_hut'],
