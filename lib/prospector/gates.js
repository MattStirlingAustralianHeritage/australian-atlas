...
const VERTICAL_LABELS = {
  ...
  collection: 'Culture Atlas — art museums, public galleries, science centres, discovery centres, curated private collections, sculpture parks, art archives, cultural heritage collections, natural history museums, independent cinemas, independent drive-ins. NOT tourism info centres, NOT commercial theme parks, NOT chain cinemas (Hoyts, Village, Dendy, Palace, Reading, EVT/Event Cinemas), NOT performing arts theatres without a film programme, NOT venues where collections are incidental to the primary purpose.',
