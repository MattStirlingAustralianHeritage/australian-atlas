 ...
 *
 * Stage 3 verification uses these variants to test whether a page
 * actually mentions the operator (vs being a generic body page that
 * passes URL validation but isn't operator-specific).
 *
