        ...
        <table role="presentation" width="520" cellpadding="0" cellspacing="0" border="0" style="width:520px; max-width:520px; background:#ffffff; border:1px solid #e7e3db; border-radius:14px;">
          <tr>
            <td class="card" align="center" style="padding:44px 48px 40px 48px;">
              ...
              <p style="margin:0; font-family:'DM Sans',-apple-system,BlinkMacSystemFont,'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:12px; font-weight:300; line-height:1.6; color:#9a958c;">Sign-in links expire. If this one has, go to <a href="https://www.australianatlas.com.au/login" style="color:#5f8a7e;">australianatlas.com.au/login</a> and choose &ldquo;Use magic link instead&rdquo;.${listingUrl ? `<br>Your public listing: <a href="${listingUrl}" style="color:#5f8a7e;">${escapeHtml(listingUrl)}</a>` : ''}</p>
            </td>
          </tr>
        </table>
      </td>
