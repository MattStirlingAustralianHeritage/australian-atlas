...
export function claimRemediationEmail({
  ...
  const bodyHtml = `
    ...
    <p style="${BODY_P}">If you&rsquo;ve never managed to sign in and use the listing, the link below will confirm your address and let you choose a password. After that you can sign in any time with your email and that password.</p>`
