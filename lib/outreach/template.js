...
export function buildMergeContext(listing, origin = SITE, personalNote = '') {
 ...
 */
export function renderEmail({ subject, body, listing, origin = SITE, unsubscribeUrl, personalNote = '' }) {
  const ctx = buildMergeContext(listing, origin, personalNote)
