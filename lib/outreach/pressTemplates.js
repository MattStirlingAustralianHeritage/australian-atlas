...
It's a working source, not a mailing list: ready-to-run regional story leads, a data room with network-wide numbers you can cite, a media kit, and direct intros to the operators behind any place we cover. The newsroom's in beta right now, so it's free for working press for the coming months while we build it out.
...
If it's useful for your reporting, reply and I'll set you up with newsroom access, or just pull whatever you need from the pages above.
...
Everything's here — the newsroom's in beta, so it's free for press for the coming months:
...
Happy to line up an interview or pull specific data for {{outlet_name}} — just reply.
...
A short follow-up on my earlier note. Australian Atlas is a curated guide to independent Australian places, and our press newsroom — in beta, and free for press for the coming months — is a source of regional story leads, citable data, and intros to the operators behind them.

If it's worth a look for your {{beat}} reporting, everything's here:
