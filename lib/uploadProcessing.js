...
// Formats we accept, intersected with what THIS sharp binary can actually decode.
// Prebuilt sharp/libvips binaries vary — the Vercel one decodes HEIC/HEIF but NOT
// AVIF. Deriving the set from sharp.format keeps validation honest: iPhone HEIC
// photos are accepted, and a format the binary can't read is rejected cleanly
// rather than failing deep in processing. SVG is deliberately excluded
// (stored-XSS vector) even though sharp can rasterise it.
const CANDIDATE_INPUT_FORMATS = ['jpeg', 'png', 'webp', 'gif', 'tiff', 'heif', 'avif']
