...
// Canonical Way Atlas primary types (extends Spec Section III).
...
export const WAY_PRIMARY_TYPE_LABELS = {
  ...
  marine_touring: 'Marine touring',
  hot_air_balloon: 'Hot air ballooning',
  marine_wildlife_swim: 'Marine wildlife swim',
  whale_watching: 'Whale watching',
  snorkelling: 'Snorkelling',
  surf_school: 'Surf school',
  rock_climbing: 'Rock climbing & abseiling',
  mountain_biking: 'Mountain biking',
  stargazing: 'Stargazing & astronomy',
  paragliding: 'Paragliding & hang gliding',
  whitewater_rafting: 'White-water rafting',
  camel_trek: 'Camel trekking',
  gold_prospecting: 'Gold prospecting & fossicking',
  canyoning: 'Canyoning',
}
