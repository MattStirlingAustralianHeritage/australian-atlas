...
// bookkeeping (e.g. a do-not-contact suppression when the operator asked
// for removal). Contacted operator_outreach rows survive the delete as
// detached history — migration 258 stamps them with the listing name and
// severs listing_id (SET NULL); never-contacted rows are pruned.
//
