...
const SUBTYPE_NOUNS = {
  ...
  waterfall:     { singular: 'waterfall',      plural: 'waterfalls' },
 ...
 * Pattern: "Day N — [Geographic descriptor], [mode hint]."
 */
export function generateDayHeading(stops, dayIndex, tripCenter) {
