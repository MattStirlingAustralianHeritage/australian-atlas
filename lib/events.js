...
const SELECT_COLS =
  ...
  'location_name, suburb, state, image_url, ticket_url, status, published, ' +
...
export async function createEvent(sb, {
  ...
  startDate, endDate, ticketUrl, isFree, heroImageUrl, published,
  state, vertical, regionId, listingName, listingHero, listingSuburb,
