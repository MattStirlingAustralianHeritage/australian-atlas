...
export const SERVICE_TRADE_DISQUALIFIERS = [
  ...
  { id: 'signwriting', re: /\bsign\s?writ(?:er|ers|ing)\b|\bsignage\b/i,                            label: 'signwriter/signage',             action: 'review' },
  { id: 'printservice', re: /\b(?:digital|offset|commercial|wide[-\s]format)\s+printing\b|\bprint(?:ing)?\s+(?:shop|services|solutions)\b/i, label: 'commercial printing', action: 'review' },
  { id: 'designagency', re: /\b(?:graphic|web)\s+design(?:er|ers)?\b|\b(?:marketing|advertising|creative)\s+agency\b/i, label: 'design/marketing agency',  action: 'review' },
  { id: 'workwear',    re: /\bworkwear\b|\buniforms?\b/i,                                           label: 'workwear/uniform supplier',      action: 'review' },
  { id: 'hire',        re: /\b(?:equipment|party|event|plant)\s+hire\b/i,                           label: 'hire company',                   action: 'review' },
  { id: 'cleaning',    re: /\b(?:cleaning\s+services?|commercial\s+cleaning)\b/i,                   label: 'cleaning services',              action: 'delete' },
]
...
const NAME_ONLY_IDS = new Set([
  ...
  // 2026-07: "follow the signage", "printing workshops", "canoe/equipment hire
  // available", museum "uniforms" — all innocent in venue copy; name-only.
  'signwriting', 'printservice', 'designagency', 'workwear', 'hire', 'cleaning',
])
