...
// Shared role tests — also consumed by the concierge (lib/trail/concierge.js)
// so "does this trail have coffee / lunch / a bed" is decided one way.
export const isCoffee = (l) => l.vertical === 'fine_grounds' || (l.vertical === 'table' && COFFEE_SUBTYPES.has(l.sub_type))
export const isLunch = (l) => l.vertical === 'table' && LUNCH_SUBTYPES.has(l.sub_type)
export const isStay = (l) => l.vertical === 'rest'
export { corridorDistanceKm }
