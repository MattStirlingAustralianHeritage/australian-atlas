...
export const CANDIDATE_PROMPT_VERSION = '2026-04-29.1'
...
export function buildCandidatePrompt({
  ...
  return `You are a curation editor for the Australian Atlas, helping shape an editorial trail. The thesis below is the editorial argument the trail will make. Your job is to choose 8–12 stops from the candidate pool that best serve the thesis, ordered into a coherent route.
...
Before returning:
- 8 to 12 stops, each one in the candidate pool by listing_id.
