  ...
  input_schema: {
    ...
    properties: {
      ...
      supporting_listings: {
        ...
        maxItems: 4,
        description:
          'Optional supporting venues (up to four). Empty for single-anchor pitches. In Phase 2 of the build this is always empty — leave as [].',
        items: {
          type: 'object',
          additionalProperties: false,
          properties: {
      ...
      verified_facts: {
        ...
        items: {
          ...
          properties: {
            ...
            value: {
              description:
                'The cell value supporting the claim, copied verbatim from the listings record. May be string, number, boolean, or array — match the column type.',
            },
          },
      ...
      editorial_framing: {
        ...
        minLength: 40,
        description:
          'The creative angle, voice suggestion, and structural ideas for the writer. Explicitly distinct from the verified facts. Plain prose — speculation about angle/voice is fine here; speculation about the venue is not.',
      },
      research_needed: {
        type: 'array',
        description:
