 ...
 */
export const PHASE_2_PROMPT_VERSION = 'phase2-v2-2026-05-22'
...
- Every named entity, date, number, and factual claim that appears in your headline or angle MUST also appear as a verified_facts entry, cited to its database field. Derived calculations (e.g. "166 years" computed from a founding date) count as factual claims and must appear in verified_facts if used. If you cannot ground a number or claim through verified_facts, do not include it in the headline or angle — rephrase to avoid it.
