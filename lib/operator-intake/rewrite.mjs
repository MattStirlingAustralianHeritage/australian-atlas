...
import { resolveAnthropicKey, renderStoryAnswers } from './generate.mjs'
...
function renderFacts(facts) {
  ...
  if (storyBlock) lines.push('Interview answers in the operator’s own words (source material, same rules):', storyBlock)
