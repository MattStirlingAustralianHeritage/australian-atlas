...
const VERTICAL_LISTING_PATH_PREFIX = {
  ...
  found: '/shops',
  table: '/listings',
  way: '/operator',          // Way's primary entity is the operator; experiences are nested under /operator/[slug]/experiences/[exp-slug] in Phase 3.
}
...
export const VERTICAL_CATEGORIES = {
  ...
  collection: ['museum', 'gallery', 'heritage_site', 'cultural_centre', 'botanical_garden', 'sculpture_park', 'cinema', 'drive_in'],
