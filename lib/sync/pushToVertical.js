...
export const VERTICAL_CATEGORIES = {
  ...
  corner: ['bookshop', 'records', 'homewares', 'design_store', 'stationery', 'jewellery', 'toys', 'general', 'clothing', 'food_drink', 'plants', 'nursery', 'specialty_retail', 'other'],
  found: ['vintage_clothing', 'vintage_furniture', 'vintage_store', 'antiques', 'op_shop', 'books_ephemera', 'art_objects', 'market'],
  table: ['restaurant', 'bakery', 'market', 'farm_gate', 'artisan_producer', 'specialty_retail', 'destination', 'cooking_school', 'providore', 'food_trail', 'cafe', 'creamery', 'chocolatier', 'confectioner', 'tea_shop', 'wine_bar', 'oyster_farm', 'historic_pub', 'ice_creamery', 'cheesemonger'],
