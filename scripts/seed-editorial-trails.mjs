...
async function seedTrail1() {
  ...
  const trail = {
    ...
    curator_note: null,
    cover_image_url: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=1600&q=80',
...
async function seedTrail2() {
  ...
  const trail = {
    ...
    curator_name: 'Australian Atlas Editorial',
    curator_note: null,
    cover_image_url: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=1600&q=80',
