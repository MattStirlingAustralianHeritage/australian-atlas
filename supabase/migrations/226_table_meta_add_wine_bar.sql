...
-- (lib/sync/pushToVertical.js). Adds 'wine_bar' — independent wine bars pouring
-- by the glass (natural / low-intervention specialists, cellar bars, enotecas,
-- and wine rooms with small plates); distinct from restaurant (food-first) and
-- from wineries / cellar doors (producers, an SBA sub_type).
