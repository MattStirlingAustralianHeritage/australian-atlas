...
export async function GET() {
  ...
  try {
    ...
    const { data, error } = await sb
      .from('events')
      .select('id, name, slug, description, location_name, start_date, end_date, submitter_email, submitter_name, status, payment_status, stripe_payment_intent_id, submitted_at, approved_at')
      .eq('status', 'pending')
