...
const VERTICAL_FIELDS = {
  ...
  way: [
    { key: 'primary_type', label: 'Primary Type', type: 'select', options: [
      ...
      { value: 'marine_touring',             label: 'Marine Touring' },
      ...
      { value: 'rock_climbing',              label: 'Rock Climbing & Abseiling' },
      { value: 'mountain_biking',            label: 'Mountain Biking' },
      { value: 'stargazing',                 label: 'Stargazing & Astronomy' },
      { value: 'paragliding',                label: 'Paragliding & Hang Gliding' },
      { value: 'whitewater_rafting',         label: 'White-water Rafting' },
      { value: 'camel_trek',                 label: 'Camel Trekking' },
      { value: 'gold_prospecting',           label: 'Gold Prospecting & Fossicking' },
