  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 }}>
        <StatCard n={`${st.sent_today ?? 0} / ${form.daily_send_cap}`} label="sent in last 24h" />
      ...
      <div style={{ ...card, background: '#fff', padding: '6px 18px 2px', marginBottom: 16 }}>
        <SettingRow
          ...
          desc="Every weekday morning (08:30 AEST): sync claims, scan the next unchecked operator websites for contact emails, and AI-write personal openers. No email is sent by this switch alone."
        >
